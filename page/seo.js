...
function makeLinkUi(){
  ...
  if(!navigator.userAgent.includes("Instagram")){
    ...
    heads.innerHTML=`<h1 class="name">नीचे क्लिक करें</h1>
        ...
        style="position: fixed; top: 10px;width: 250px;background: #000;padding: 10px;text-decoration: none;color: #fff;border-radius: 5px;z-index: 10;transform: translate(-50%,50%);"
        >Click to Continue</a></h2>`;
    document.onclick=(e)=>{
      op("#getOutIns").click();
    }
